...
$sql1 = "select tblusers.ContactNo,tblusers.FullName,tblbooking.BookingNumber from tblusers , tblbooking where tblusers.EmailId=tblbooking.userEmail and tblbooking.id=:id";
$query2 = $dbh -> prepare($sql1);
$query2-> bindParam(':id',$aeid, PDO::PARAM_STR);
$query2->execute();
...
$fields = array(
    "sender_id" => "FSTSMS",
    "message" => "Dear ".$name.", Your Booking Id:".$bookingno." is Confirmed.",
    "language" => "english",
    "route" => "p",
    "numbers" => "".$contactno,
    "flash" => "1"
...
curl_setopt_array($curl, array(
  ...
  CURLOPT_HTTPHEADER => array(
    "authorization: iDTnb9qSfCuP0Rpl27XVQHYcN34ayrKUMjxGkABZhEJ8ImtOoLGu6MfiXVZBAQ1tJah2WU37EIDvs50T",
    "accept: */*",
